...
Prvi zemljevid prikazuje skupno število vseh medalj, države z najmanj medaljami so obarvane temno, tiste z največ medaljami pa svetlo modro. Drugi zemljevid prikazuje število medalj na prebivalca. Države sem razdelila v deset enakovrednih skupin. S temno modro barvo so pobarvane države, ki imajo najmanj medalj na prebivalca in s svetlo tiste ki imajo največ medalj naprebivalca.

```{r zemljevid.medalje, echo=FALSE, fig.align='center', fig.cap='Zemljevid 1'}
zemljevid.medalje
```

```{r zemljevid.medalje.preb, echo=FALSE, fig.align='center', fig.cap='Zemljevid 1'}
