...
zenske.400m <- lapply(2:11, function(i) uvozi.rezultati(paste0("https://www.iaaf.org", povezave[i],
                                                           ...
                                                           2021 - 2*i)) %>% bind_rows() %>% select(-BIB)
# testna
tabela1 <- uvozi.rezultati_100z("https://www.iaaf.org/competitions/iaaf-world-championships/13th-iaaf-world-championships-in-athletics-4147/results/women/100-metres/final/result", 2017)
tabela2 <- uvozi.rezultati_100z("https://www.iaaf.org/competitions/iaaf-world-championships/iaaf-world-championships-london-2017-5151/results/men/100-metres/final/result", 2017)
